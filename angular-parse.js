(function() {
  ...
  module.factory('ParseAuth', [
    'persist', 'ParseUser', 'ParseUtils', '$q', function(persist, ParseUser, ParseUtils, $q) {
      var auth;
      return auth = {
        sessionToken: null,
        currentUser: null,
  ...
  module.factory('ParseModel', [
    'ParseUtils', function(ParseUtils) {
      var Model;
  ...
  module.factory('ParseDefaultUser', [
  ...
  module.factory('ParseUser', [
    'ParseDefaultUser', 'ParseCustomUser', function(ParseDefaultUser, ParseCustomUser) {
  ...
  module.provider('Parse', function() {
    return {
      ...
      $get: [
        'ParseModel', 'ParseUser', 'ParseAuth', 'ParseUtils', function(ParseModel, ParseUser, ParseAuth, ParseUtils) {
          return {
  ...
  angular.module('Parse').factory('ParseCustomUser', [
    'ParseDefaultUser', function(ParseDefaultUser) {
      return ParseDefaultUser;
    }
  ]);
